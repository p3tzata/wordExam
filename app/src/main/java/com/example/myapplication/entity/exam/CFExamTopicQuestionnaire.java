...
import com.example.myapplication.database.DateConverter;
...
@Entity(
        ...
        foreignKeys = {
                ...
                @ForeignKey(onDelete = ForeignKey.SET_NULL,entity = Topic.class, parentColumns = "topicID", childColumns = "topicID")
        }
)
