...
import com.example.myapplication.adapter.exam.RandomExamTranslationListAdapter;
...
public class RandomExamListAllDictionaryActivity extends AppCompatActivity {
    ...
    private void getTranslation() {
        class GetTasks extends AsyncTask<Void, Void, List<TranslationAndLanguages>> {
            ...
            protected List<TranslationAndLanguages> doInBackground(Void... voids) {
                ...
                long profileID = Session.getLongAttribute(RandomExamListAllDictionaryActivity.this, SessionNameAttribute.ProfileID, 0);
            ...
            protected void onPostExecute(List<TranslationAndLanguages> tasks) {
                ...
                RandomExamTranslationListAdapter adapter = new RandomExamTranslationListAdapter(getApplicationContext());
