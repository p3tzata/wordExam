...
public class NativeWordListableAdapter extends BaseRecycleAdapterFaced<BaseListableAppCompatActivityFaced, WordCFExamCross,Word, BaseRecycleAdapterFaced.ItemViewHolder> {

    public NativeWordListableAdapter(BaseListableAppCompatActivityFaced context) {
        super(context);
    }
