...
public abstract class BaseEditableAppCompatActivityFaced<
        V extends TextLabelable,
        T extends TextLabelable,
        S extends CrudService<T>,
        C extends BaseEditableAppCompatActivityFaced,
        A extends BaseRecycleAdapterFaced>
        extends BaseListableAppCompatActivityFaced<V,T,S,C,A> implements EditableAppCompatActivity<T> {
